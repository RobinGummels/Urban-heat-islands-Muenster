...
def z_transformed_boxplot_lst_by_class():
    ...
    Saves figure to ../data/plots/lst-normalized_boxplots_by_class.png
    """
    gdal.UseExceptions()
    ...
    ax.set_xlabel('Class')
    ax.set_ylabel('Standardized LST (z-score)')
    ...
    plt.tight_layout()
    out_path = os.path.join(plots_dir, 'lst-normalized_boxplots_by_class.png')
    plt.savefig(out_path, dpi=600, transparent=True)
    plt.show()

if __name__ == '__main__':
    z_transformed_boxplot_lst_by_class()
